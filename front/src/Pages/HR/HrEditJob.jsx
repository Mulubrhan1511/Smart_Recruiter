      ...
      <div className="container mx-auto px-4 py-8 lg:px-72">
        {success && (
          <div id="toast-success" className="z-50 justify-end right-0 fixed flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800">
            ...
            <div className="ms-3 text-sm font-normal">Job Updated successfully.</div>
          </div>
        )}
        ...
        <h1 className="text-2xl font-semibold mb-4 items-center">Edit Job</h1>
  ...
  >
    ...
    <option value="5+ years">5+ years</option>
      ...
      />
            ...
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={submit}>Update Job</button>
          </div>
        </div>  
      </div>
    </div>
